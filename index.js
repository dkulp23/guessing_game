...
//
// var myNumber = 4;
// var userAnswerSeven = parseInt(prompt('I\'m thinking of a number between 1 and 10. Can you guess it?'));
// var i = 1;
// if (userAnswerSeven !== myNumber) {
//   if (userAnswerSeven < myNumber) {
//     while (i <= 3) {
//       prompt ('Sorry. ' + userAnswerSeven + ' is too low. Try again.');
//       i++;
//   } else {
//     while (i <= 3) {
//       prompt ('Sorry. ' userAnswerSeven + ' is too high. Try again.');
//       i++;
//     }
// } else {
//   prompt ('Wow. You got it right on the first try. You must be a mind reader!')
// };
...
getUserNumber();
// console.log(userAnswerSeven);
// if (userAnswerSeven === myNumber) {
//   alert('Wow! You got it on your first try! You must be a mind reader.');
// } else {
//   while (userAnswerSeven !== myNumber) {
//     getUserNumber();
//   }
// };
